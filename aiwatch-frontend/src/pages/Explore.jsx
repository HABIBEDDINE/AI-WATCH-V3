...
export default function Explore() {
  ...
  const handleGenerateReport = () => {
    ...
    if (reportFormat === "pdf") {
      // Create simple PDF-like content (browser will download as text, user can print as PDF)
      const pdfContent = `
AI WATCH REPORT
Generated: ${new Date().toLocaleString()}
${"=".repeat(80)}
...
Report generated by AI Watch v2.0
`;
      const filename = `ai-watch-report-${new Date().toISOString().split('T')[0]}.txt`;
